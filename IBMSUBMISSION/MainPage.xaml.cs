...
namespace IBMSUBMISSION
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        private async Task COPILOT()
        {
            try
            {
                var inputs = await SpeechToText.Default.ListenAsync(new System.Globalization.CultureInfo("id-ID"), new Progress<string>() { }, default);
                string compile = inputs.Text;
                string finalinput = compile.ToUpper();
            ...
            {
                //ini akan digunakan untuk sistem software RPA DAN STUDIO STUDIO LAIN
